...
public class EmailAndSmsService {
	...
	public List<UserDto> getUsersEmailSms(List<String> regions,List<Integer> products,String sendMethod,String sms_content,String email_title,String email_content)
	{
