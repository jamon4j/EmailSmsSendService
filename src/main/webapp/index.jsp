...
<form class="query_form" name="queryForm" method="post" action="/g/emailsms/getEmailSms" >
...
<label><input id="KVM" name="product_checkbox" type="checkbox" value="1" />KVM </label> 
